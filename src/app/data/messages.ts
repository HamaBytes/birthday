...
export const INTRO_MESSAGES = {
  title: 'For Tasnim',
  subtitle: 'Happy Birthday, beautiful ✨',
  description1: 'Today is all about celebrating you and the happiness you bring to the world.',
  description2: 'I made this little surprise with all my love, just for you.',
  button: 'Please, open my heart',
};

/* ---- PUZZLE GAME TEXT ---- */
export const PUZZLE_MESSAGES = {
  title: '💕 Mend the Heart 💕',
  instruction1: 'A tiny birthday game, made especially for you.',
  instruction2: 'Drag each half of the heart into the middle to unlock your surprise.',
